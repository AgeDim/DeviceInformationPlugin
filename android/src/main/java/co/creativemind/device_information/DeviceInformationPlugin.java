...
/** DeviceInformationPlugin — совместимая с новым embedding API версия */
public class DeviceInformationPlugin implements FlutterPlugin, MethodCallHandler, ActivityAware {
    ...
    public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
        switch (call.method) {
            ...
            case "getCPUType":
                result.success(Build.SUPPORTED_ABIS.length > 0 ? Build.SUPPORTED_ABIS[0] : "unknown");
                break;
    ...
    private String getDeviceUniqueID() {
        ...
        try {
            ...
            return stringWithSymbols
                    ...
                    .replaceAll("-", "")
                    .replaceAll(" ", "")
                    .substring(0, Math.min(15, stringWithSymbols.length()));
        } catch (Exception e) {
            return "";
        }
    }
